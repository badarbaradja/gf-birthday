...
const PasswordPage: React.FC<PasswordPageProps> = ({ onNext }) => {
  ...
  const correctPassword = '13082024';
  ...
  return (
    <div className="text-center space-y-6 sm:space-y-8 px-4">
      <div className="space-y-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold gradient-text leading-relaxed">Do you still remember our anniversary?</h2>
