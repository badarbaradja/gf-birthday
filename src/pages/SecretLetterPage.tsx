      ...
      <AnimatePresence>
        {showFinalMessage && (
          ...
          >
            ...
            {/* Back to start button (SUDAH DIPERBAIKI) */}
            {onBackToStart && (
              <motion.button
                onClick={onBackToStart}
                className="mt-6 px-6 py-3 bg-gradient-to-r from-pink-400 to-pink-500 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
